...
DB_CONTAINER_NAME="toronto_drip-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=toronto_drip -d -p 5432:5432 docker.io/postgres
